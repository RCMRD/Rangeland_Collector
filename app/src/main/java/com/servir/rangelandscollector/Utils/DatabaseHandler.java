...
public class DatabaseHandler extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase db) {
        ...
        String CREATE_KOLEKDAT_TABLE_VEG = "CREATE TABLE " + Constantori.TABLE_DAT_VEG + "("
                + Constantori.KEY_RID_VEG + " INTEGER PRIMARY KEY AUTOINCREMENT,"
                + Constantori.KEY_DATNO + " VARCHAR,"
                + Constantori.KEY_DATFEATURE_VEG + " VARCHAR,"
                + Constantori.KEY_DATCOMMENT_VEG + " VARCHAR,"
                + Constantori.KEY_DATLON_VEG + " VARCHAR,"
                + Constantori.KEY_DATLAT_VEG + " VARCHAR,"
                + Constantori.KEY_DATPICNAME_VEG + " VARCHAR,"
        ...
        String CREATE_KOLEKDAT_TABLE_INV = "CREATE TABLE " + Constantori.TABLE_DAT_INV + "("
                + Constantori.KEY_RID_INV + " INTEGER PRIMARY KEY AUTOINCREMENT,"
                + Constantori.KEY_DATNO + " VARCHAR,"
                + Constantori.KEY_DATFEATURE_INV + " VARCHAR,"
                + Constantori.KEY_DATAREA_INV + " VARCHAR,"
                + Constantori.KEY_DATCOMMENT_INV + " VARCHAR,"
                + Constantori.KEY_DATLON_INV + " VARCHAR,"
                + Constantori.KEY_DATLAT_INV + " VARCHAR,"
                + Constantori.KEY_DATPICNAME_INV + " VARCHAR,"
                + Constantori.KEY_DATSTATUS + " VARCHAR,"
                + Constantori.KEY_USERREF + " VARCHAR"
                + ")";
        db.execSQL(CREATE_KOLEKDAT_TABLE_INV);
    ...
    public void onUpgrade(SQLiteDatabase db, int oldVersion, int newVersion) {
        ...
        db.execSQL("DROP TABLE IF EXISTS " + Constantori.TABLE_DAT_VEG);
        db.execSQL("DROP TABLE IF EXISTS " + Constantori.TABLE_DAT_WAT);
        db.execSQL("DROP TABLE IF EXISTS " + Constantori.TABLE_DAT_INV);
    ...
    //VEG/////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    public void KolekData_UpdateAll_VEG(JSONArray storesArray) {
        ...
        try {
            ...
            for (int i = 0; i < storesArray.length(); i++) {
                ...
                values.put(Constantori.KEY_DATFEATURE_VEG, store.getString(Constantori.KEY_DATFEATURE_VEG));
                values.put(Constantori.KEY_DATCOMMENT_VEG, store.getString(Constantori.KEY_DATCOMMENT_VEG));
                values.put(Constantori.KEY_DATLON_VEG, store.getString(Constantori.KEY_DATLON_VEG));
                values.put(Constantori.KEY_DATLAT_VEG, store.getString(Constantori.KEY_DATLAT_VEG));
                values.put(Constantori.KEY_DATPICNAME_VEG, store.getString(Constantori.KEY_DATPICNAME_VEG));
                values.put(Constantori.KEY_DATSTATUS, store.getString(Constantori.KEY_DATSTATUS));

                db.update(Constantori.TABLE_DAT_VEG, values, Constantori.KEY_USERREF + "=? AND " + Constantori.KEY_DATNO + "=?", new String[]{sref,sdat});
            ...
            Log.e(Constantori.APP_ERROR_PREFIX + "_KolUpSQLVeg", xx.getMessage());
            xx.printStackTrace();
    ...
    public void KolekData_InsertAll_VEG(JSONArray storesArray) {
        ...
        try {
            ...
            for (int i = 0; i < storesArray.length(); i++) {
                ...
                db.insert(Constantori.TABLE_DAT_VEG, null, values);
            ...
            Log.e(Constantori.APP_ERROR_PREFIX + "_KolInSQLVeg", xx.getMessage());
            xx.printStackTrace();
    ...
    //INV/////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    public void KolekData_UpdateAll_INV(JSONArray storesArray) {
        ...
        try {
            ...
            for (int i = 0; i < storesArray.length(); i++) {
                ...
                values.put(Constantori.KEY_DATFEATURE_INV, store.getString(Constantori.KEY_DATFEATURE_INV));
                values.put(Constantori.KEY_DATAREA_INV, store.getString(Constantori.KEY_DATAREA_INV));
                values.put(Constantori.KEY_DATCOMMENT_INV, store.getString(Constantori.KEY_DATCOMMENT_INV));
                values.put(Constantori.KEY_DATLON_INV, store.getString(Constantori.KEY_DATLON_INV));
                values.put(Constantori.KEY_DATLAT_INV, store.getString(Constantori.KEY_DATLAT_INV));
                values.put(Constantori.KEY_DATPICNAME_INV, store.getString(Constantori.KEY_DATPICNAME_INV));
                values.put(Constantori.KEY_DATSTATUS, store.getString(Constantori.KEY_DATSTATUS));

                db.update(Constantori.TABLE_DAT_INV, values, Constantori.KEY_USERREF + "=? AND " + Constantori.KEY_DATNO + "=?", new String[]{sref,sdat});
            ...
            Log.e(Constantori.APP_ERROR_PREFIX + "_KolUpSQLINV", xx.getMessage());
            xx.printStackTrace();
    ...
    public void KolekData_InsertAll_INV(JSONArray storesArray) {
        ...
        try {
            ...
            for (int i = 0; i < storesArray.length(); i++) {
                ...
                db.insert(Constantori.TABLE_DAT_INV, null, values);
            ...
            Log.e(Constantori.APP_ERROR_PREFIX + "_KolInSQLINV", xx.getMessage());
            xx.printStackTrace();
    ...
    public void emptyAllTables() {
        ...
        try {
            ...
            db.delete(Constantori.TABLE_DAT_INV, null, null);
            db.delete(Constantori.TABLE_DAT_VEG, null, null);
