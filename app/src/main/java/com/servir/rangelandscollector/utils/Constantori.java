...
public class Constantori {
    ...
    public static final String APP_ERROR_PREFIX = "RLC";
    public static final int DATABASE_VERSION = 3;
    public static final String DATABASE_NAME = "RLCDB";
    public static  final Context DATABASE_Context = ApplicationContextor.getAppContext();

        //Tables
        public static final String TABLE_DAT_VEG = "datVegTBL";
        public static final String TABLE_DAT_INV = "datInvTBL";
        ...
        //Fields - KOLEK-VEG Dat table
        public static final String KEY_RID_VEG = "_datindex";
        public static final String KEY_DATFEATURE_VEG = "_datftrname";
        public static final String KEY_DATCOMMENT_VEG = "_datcom";
        public static final String KEY_DATLON_VEG = "_datlon";
        public static final String KEY_DATLAT_VEG = "_datlat";
        public static final String KEY_DATPICNAME_VEG = "_datpicnm";
        ...
        //Fields - KOLEK-INV Dat table
        public static final String KEY_RID_INV = "_datindex";
        public static final String KEY_DATFEATURE_INV = "_datftrname";
        public static final String KEY_DATAREA_INV = "_datarea";
        public static final String KEY_DATCOMMENT_INV = "_datcom";
        public static final String KEY_DATLON_INV = "_datlon";
        public static final String KEY_DATLAT_INV = "_datlat";
        public static final String KEY_DATPICNAME_INV = "_datpicnm";
        ...
        public static final String SAVE_FOLDER = "/Rangelands";
    ...
    public static final String PIC_PATH = Environment.getExternalStorageDirectory().getAbsolutePath() + "/IMGRLC";
